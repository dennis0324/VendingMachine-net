...
public class Soldout extends Processing {

    public Soldout(Connection conn, String[] sqlData, Classification classification) {
    ...
    public String run(Payload payload) throws SQLException, JSONException {
        ...
        PreparedStatement ppst = conn.prepareStatement("CALL SOLDOUT(?)");
